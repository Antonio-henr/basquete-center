...
export default function Bandejaearremesso10min(props){


    const [data,setdata]=useState([
        {p:'1', color:'white', conteudo:'Arremesso de média distância: Posicione-se na zona de arremesso de média distância (por exemplo, na linha de lance livre). Faça 10 arremessos com boa técnica e foco na precisão. Concentre-se em seguir a mecânica correta de arremesso, incluindo a posição das mãos, o equilíbrio e o seguimento.'},
        {p:'2', color:'white', conteudo:'Arremesso de três pontos: Posicione-se atrás da linha de três pontos. Faça 5 arremessos de três pontos com boa técnica. Concentre-se em estender completamente o braço, manter o equilíbrio e o seguimento do arremesso. Tente acertar a maior quantidade possível de arremessos.'},
        {p:'3', color:'white', conteudo:'Bandejas: Coloque-se próximo ao aro e pratique bandejas alternando entre a mão direita e a mão esquerda. Faça 10 bandejas com cada mão, focando na técnica adequada de finalização. Concentre-se em saltar com força, usar a mão de apoio corretamente e finalizar suavemente ao redor do aro.'},
        {p:'4', color:'white', conteudo:'Arremessos em movimento: Posicione-se na linha de lance livre e comece a se movimentar ao redor da quadra, simulando situações de jogo. Receba passes de um parceiro ou faça dribles antes de arremessar. Execute 10 arremessos em movimento, trabalhando na habilidade de arremessar com precisão em diferentes posições e momentos do jogo.'},
        {p:'5', color:'white', conteudo:'Finalização após contato: Peça a um parceiro para fornecer leve contato físico enquanto você faz uma bandeja. Pratique finalizações em diferentes ângulos e posições, focando em terminar a jogada mesmo após o contato. Execute 10 finalizações após contato, mantendo o equilíbrio e a força para converter o arremesso.'},
