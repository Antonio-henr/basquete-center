...
export default function Passe10min(props){


    const [data,setdata]=useState([
        {p:'1', color:'white', conteudo:'Passe de peito: Fique em pé, com as pernas afastadas na largura dos ombros. Segure a bola com ambas as mãos na altura do peito. Faça 20 passes de peito para um alvo ou parede, concentrando-se na precisão e na velocidade do passe. Mantenha os cotovelos apontados para fora e siga a trajetória do passe com os olhos.', sub1:'', sub2:'', sub3:''},
        {p:'2', color:'white', conteudo:'Passe por cima da cabeça: Levante a bola acima da cabeça, com as duas mãos segurando-a na parte de trás da bola. Faça 20 passes por cima da cabeça para um alvo ou parede. Concentre-se em lançar a bola suavemente, usando a força dos braços e dos ombros. Mantenha os cotovelos retos durante o passe.', sub1:'', sub2:'', sub3:''},
        {p:'3', color:'white', conteudo:'Passe de bala: Fique em pé, com as pernas afastadas na largura dos ombros. Segure a bola com uma mão na altura do quadril. Faça 20 passes de bala com força para um alvo ou parede, usando um movimento rápido e explosivo do pulso. Concentre-se em lançar a bola diretamente para o alvo.', sub1:'', sub2:'', sub3:''},
        {p:'4', color:'white', conteudo:'Passe com a mão não dominante: Pratique passes com a mão não dominante para melhorar a ambidestria. Faça 10 passes de peito e 10 passes por cima da cabeça com a mão não dominante. Concentre-se na técnica correta e na precisão do passe.', sub1:'', sub2:'', sub3:''},
