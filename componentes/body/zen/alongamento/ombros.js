...
export default function Ombros(props){


    const [data,setdata]=useState([
        {p:'1', color:'white', conteudo:'Estenda um dos braços à altura do peito, na frente de você.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'2', color:'white', conteudo:'Use o outro braço para puxar o braço estendido em direção ao peito, cruzando-o na frente do corpo.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'3', color:'white', conteudo:'Mantenha o ombro estendido para evitar torções.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'4', color:'white', conteudo:'Segure por 20 a 30 segundos e repita com o outro braço.',
        sub1:'',
        sub1:'',
        sub2:'',
        sub3:'',
    ...
    return(
      <ScrollView style={{backgroundColor:'#06122B',}}>
        ...
        <View style={{width:"95%"}}>
        <Text style={{color:'white', textAlign:'center', fontSize:30}}><MaterialCommunityIcons name="clock-outline" size={30} color="white"/> ombros</Text>
