...
export default function Quadriceps(props){


    const [data,setdata]=useState([
        {p:'1', color:'white', conteudo:'Fique em pé e segure em algum suporte, como uma parede ou uma cadeira.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'2', color:'white', conteudo:'Dobre um dos joelhos, levantando o pé em direção às nádegas.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'3', color:'white', conteudo:'Segure o tornozelo com a mão correspondente e puxe-o suavemente em direção às nádegas.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'4', color:'white', conteudo:'Mantenha o equilíbrio e sinta o alongamento na frente da coxa.',
        sub1:'',
        sub1:'',
        sub2:'',
        sub3:'',
        ...
        {p:'5', color:'white', conteudo:'Segure por 20 a 30 segundos e repita do outro lado.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
    ...
    return(
      <ScrollView style={{backgroundColor:'#06122B',}}>
        ...
        <View style={{width:"95%"}}>
        <Text style={{color:'white', textAlign:'center', fontSize:30}}><MaterialCommunityIcons name="clock-outline" size={30} color="white"/> quadríceps</Text>
