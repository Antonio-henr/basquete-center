...
export default function Flexoresdequadril(props){


    const [data,setdata]=useState([
        {p:'1', color:'white', conteudo:'Fique de pé com os pés afastados na largura dos ombros.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'2', color:'white', conteudo:'Dê um passo à frente com um dos pés, mantendo a outra perna estendida para trás.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'3', color:'white', conteudo:'Incline-se para a frente, apoiando-se no joelho dobrado, até sentir um alongamento na parte da frente do quadril.',
        sub1:'',
        sub2:'',
        sub3:'',
        sub4:'',
        ...
        {p:'4', color:'white', conteudo:'Segure por 20 a 30 segundos e repita com a outra perna.',
        sub1:'',
        sub1:'',
        sub2:'',
        sub3:'',
    ...
    return(
      <ScrollView style={{backgroundColor:'#06122B',}}>
        ...
        <View style={{width:"95%"}}>
        <Text style={{color:'white', textAlign:'center', fontSize:30}}><MaterialCommunityIcons name="clock-outline" size={30} color="white"/> flexores do quadril</Text>
