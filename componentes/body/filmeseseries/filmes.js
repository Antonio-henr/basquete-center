...
export default function Series(props) {
  ...
  useEffect(()=>{
    ...
    fetch(
      "https://api.themoviedb.org/3/account/18489537/favorite/movies?language=pt-BR&page=1&sort_by=created_at.asc', options",
      options
    )
    ...
    <ScrollView style={{ backgroundColor: "black" }}>
      <TouchableOpacity onPress={props.filmeseseries}>
        ...
        >
          ...
          >
           <MaterialIcons name="local-movies" size={90} color='black'/>
          </View>
